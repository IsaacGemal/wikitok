  ...
  return (
    <div className="h-screen w-full flex items-center justify-center snap-start relative">
      <div className="h-full w-full relative">
        ...
        <div className="absolute bottom-[3vh] md:-left-14 right-0 md:p-6 text-white z-10 md:container md:mx-auto">
          <div className="md:bg-black/30 md:backdrop-blur-sm md:rounded-4xl p-2 md:p-8 md:max-w-6xl">
            <div className="flex justify-between items-start mb-3">
              ...
              >
                <h2 className="text-4xl font-semibold drop-shadow-lg mb-1">
                  {article.title}
                </h2>
              </a>
              <button
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1 hover:gap-2 transition-all duration-300 text-white hover:text-gray-200 drop-shadow-lg"
            >
              <span>Read more</span> <span className="text-xl">→</span>
            </a>
          </div>
        </div>
      </div>
